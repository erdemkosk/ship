...
// Workgroup size == largest supported map size. Dropped from 1024 to 512:
// at map_size 256 a 1024-wide group idles three quarters of its threads and
// burns 16 KB of shared memory per group, which is what caps occupancy.
